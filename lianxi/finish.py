...
#    plt.show()
    ...
    print("kkkkk",k)
    output=sys.stdout
    outputfile=open("C:\\Users\\HP-I7\\Desktop\\aadd\\64pid2.txt","a")
    sys.stdout=outputfile
    #画出投影后的点
    plt.plot(x,yy)
    cloo=np.array(['#FFE4B5','#00FF00','#F5FFFA','#F0F8FF', '#FAEBD7', '#00FFFF', '#7FFFD4', '#F0FFFF', '#F5F5DC', '#FFE4C4', '#000000', '#FFEBCD', '#0000FF', '#8A2BE2', '#A52A2A', '#DEB887', '#5F9EA0', '#7FFF00', '#D2691E', '#FF7F50', '#6495ED', '#FFF8DC', '#DC143C', '#00FFFF', '#00008B', '#008B8B', '#B8860B', '#A9A9A9', '#006400', '#BDB76B', '#8B008B', '#556B2F', '#FF8C00', '#9932CC', '#8B0000', '#E9967A', '#8FBC8F', '#483D8B', '#2F4F4F', '#00CED1', '#9400D3', '#FF1493', '#00BFFF', '#696969', '#1E90FF', '#B22222', '#FFFAF0', '#228B22', '#FF00FF', '#DCDCDC', '#F8F8FF', '#FFD700', '#DAA520', '#808080', '#008000', '#ADFF2F', '#F0FFF0', '#FF69B4', '#CD5C5C', '#4B0082', '#FFFFF0', '#F0E68C', '#E6E6FA', '#FFF0F5', '#7CFC00', '#FFFACD', '#ADD8E6', '#F08080', '#E0FFFF', '#FAFAD2', '#90EE90'])
                  
 #   plt.scatter(X1[:,0],X1[:,1],marker='o',color=cloo[jj],s=10)#原始数据的点
  #  plt.scatter(X2[:,0],X2[:,1],marker='o',color=cloo[kk],s=10)#原始数据的点
    plt.grid()
    plt.plot(xi,yi,color=cloo[jj],marker='x')
    plt.plot(xj,yj,color=cloo[kk],marker='x')
